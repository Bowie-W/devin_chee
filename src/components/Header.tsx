...
export default function Header(): ReactElement {
  return (
    <div className="header_container">
      ...
      <div>
        <div className="header_middle-box">
          <img src="/icon.png" alt="madelusiv_logo" className="header_icon">
          </img>
          <h1 className="header_title"> Madelusiv</h1>   </div>
      ...
      <div className="header_right-box">
        <div className="header_right-box_icons">
          ...
          <Link to='https://soundcloud.com/de_vinchee' className="soundCl_bg">  <svg
            xmlns="http://www.w3.org/2000/svg"
